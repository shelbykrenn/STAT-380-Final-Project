...
ggplot(data = PetFinder) +
  geom_bar(data = less_half, aes(x = Color1), fill = 'lightblue') +
  geom_bar(data = half_to_one, aes(x = Color1), fill = 'lightpink') +
  geom_bar(data = one_to_three, aes(x = Color1), fill = 'lightgray') +
  geom_bar(data = three_to_six, aes(x = Color1), fill = 'lightgreen') +
  geom_bar(data = six_to_nine, aes(x = Color1), fill = 'white') +
  geom_bar(data = nine_to_twelve, aes(x = Color1), fill = 'blue') +
  geom_bar(data = twelve_plus, aes(x = Color1), fill = 'red') +
  facet_grid(~ Type) +
