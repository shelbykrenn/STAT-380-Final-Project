...
ggplot(data = PetFinder) +
  geom_point(aes(x = Age, y = Fee, color = Gender, shape = MaturitySize)) +
  facet_grid(Gender ~ Type)
```

When examining Fees in comparison to characteristics of the animals, there is a slight trend when it comes to Age, as discussed previously, but in regards to Gender, Species, and Size, there does not seem to be any strongly preffered factor. Because of this, when Malaysian shelters are advertising and advocating for animals other than the strongly preferred, there should be a very similar distribution amoungst all of them adopted. 
